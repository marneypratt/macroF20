...
#Save this data file
write.csv(ARIK_fieldData, "NEONdata/ARIK/ARIK_fieldData.csv")


# Make the observation table.
# start with inv_taxonomyProcessed
ARIK.macro <- inv_taxonomyProcessed %>% 
...
ARIK.macro <- left_join(ARIK.macro, neon.mill.taxa2, by="acceptedTaxonID")


# save macro data file for this site
write.csv(ARIK.macro, "NEONdata/ARIK/ARIK.macro.csv", 
          row.names = FALSE)
...
## Import NEON Macroinvertebrate Data for ARIK Site
...
ARIK.macro <- read_csv("NEONdata/ARIK/ARIK.macro.csv")
...
write.csv(precip, "NEONdata/ARIK/ARIK.precip.csv",
row.names = FALSE)
...
ARIK.precip<- read_csv("NEONdata/ARIK/ARIK.precip.csv")
...
```{r join NEON macros and environmental vars for ARIK}


# select columns needed
ARIK.precip.r <- ARIK.precip %>% dplyr::select(date, mon.precip)

# join precip to macro data
ARIK.macro.precip <- left_join(ARIK.macro, ARIK.precip.r, by = "date") 
...
write.csv(ARIK.macro.precip, "preppedData/ARIK.macro.precip.csv", 
          row.names = FALSE)
