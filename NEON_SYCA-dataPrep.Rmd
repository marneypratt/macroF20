...
#Save this data file
write.csv(SYCA_fieldData, "NEONdata/SYCA/SYCA_fieldData.csv")


# Make the observation table.
# start with inv_taxonomyProcessed
SYCA.macro <- inv_taxonomyProcessed %>% 
...
SYCA.macro <- left_join(SYCA.macro, neon.mill.taxa2, by="acceptedTaxonID")


# save macro data file for this site
write.csv(SYCA.macro, "NEONdata/SYCA/SYCA.macro.csv", 
          row.names = FALSE)
...
## Import NEON Macroinvertebrate Data for SYCA Site
...
SYCA.macro <- read_csv("NEONdata/SYCA/SYCA.macro.csv")
...
write.csv(precip, "NEONdata/SYCA/SYCA.precip.csv",
row.names = FALSE)
...
SYCA.precip<- read_csv("NEONdata/SYCA/SYCA.precip.csv")
...
```{r join NEON macros and environmental vars for SYCA}


# select columns needed
SYCA.precip.r <- SYCA.precip %>% dplyr::select(date, mon.precip)

# join precip to macro data
SYCA.macro.precip <- left_join(SYCA.macro, SYCA.precip.r, by = "date") 
...
write.csv(SYCA.macro.precip, "preppedData/SYCA.macro.precip.csv", 
          row.names = FALSE)
